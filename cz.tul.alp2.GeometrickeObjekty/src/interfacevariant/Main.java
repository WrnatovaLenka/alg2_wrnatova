...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ShapeInterface> shapes3 = new ArrayList<>(); //dynamicke pole objektu typu, ktere implementuji ShapeInterface
        //muze obsahovat cokoliv co je typove kompatibilni s ShapeInterface (Circle, Rectangle)
